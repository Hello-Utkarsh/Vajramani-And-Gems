      ...
      <div className='flex justify-between p-2 flex-wrap'>
        ...
        <div className='mr-28 flex flex-col items-center justify-center font-semibold'>
          ...
          <div className='flex w-[100%] justify-around'>
            <button className='bg-[#e3874f] text-[#37363e] rounded-xl text-center text-xl w-28'>Categories</button>
            <button className='bg-[#e3874f] text-[#37363e] rounded-xl text-center text-xl h-10 w-28'>Categories</button>
          </div>
        </div>
      </div>
