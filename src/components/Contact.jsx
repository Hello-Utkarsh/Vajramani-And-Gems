...
const Contact = () => {
  return (
    <div className='bg-black text-[#C07F00] w-[100vw]'>
      ...
      <div className='w-[80%] mt-8 m-auto flex justify-around flex-wrap'>
        <h4 className='text-lg'>Also available on</h4>
        <div className='flex w-[50%] justify-around border-2 mx-8'>
